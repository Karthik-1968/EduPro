...
class TestCreateUserInteractor:
    ...
    def setup_method(self):
        ...
        self.presenter = create_autospec(UserPresenterInterface)
    ...
    def test_if_user_already_exists_raises_exception(self):
        ...
        with pytest.raises(BadRequest):
            self.interactor.create_user(user_dto=user_dto)
    ...
    def test_create_user(self):
        ...
        actual_output = self.interactor.create_user(user_dto=user_dto)
