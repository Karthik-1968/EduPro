...
from type_form.build.view_environments.submit_data_.submit_data.submitteddata.submitteddataSerializer import submitteddataSerializer
...
options = {
    ...
    'REQUEST_SERIALIZER': submitteddataSerializer,
...
def submit_data(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "submit_data", group_name, *args, **kwargs)
