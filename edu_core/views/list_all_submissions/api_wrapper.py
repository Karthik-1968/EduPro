...
from edu_core.interactors.get_list_of_submissions_of_assignment_interactor import ListofSubmissionsInteractor
...
def api_wrapper(*args, **kwargs):
    ...
    interactor=ListofSubmissionsInteractor(storage=storage,presenter=presenter)
