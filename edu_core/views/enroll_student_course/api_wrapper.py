...
from edu_core.interactors.enroll_student_course_interactor import EnrollStudentCourse
...
def api_wrapper(*args, **kwargs):
    ...
    interactor=EnrollStudentCourse(storage=storage,presenter=presenter)
