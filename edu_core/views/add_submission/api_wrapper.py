...
from edu_core.interactors.add_submission_interactor import AddSubmission
...
def api_wrapper(*args, **kwargs):
    ...
    interactor=AddSubmission(storage=storage,presenter=presenter)
    data=interactor.add_submission(student_id=student_id,assignment_id=assignment_id,submitted_at=submitted_at,user_email=user_email)
