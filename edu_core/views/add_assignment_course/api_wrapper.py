...
from edu_core.interactors.add_assignment_to_course_interactor import AddAssignmenttoCourse
...
def api_wrapper(*args, **kwargs):
    ...
    interactor=AddAssignmenttoCourse(storage=storage,presenter=presenter)
