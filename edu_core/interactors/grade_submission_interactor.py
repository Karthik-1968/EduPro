...
class GradeSubmissionInteractor:
    ...
    def grade_submission(self,submission_id:int,user_email:str):
        ...
        try:
            ...
            self.presenter.raise_exception_for_missing_submissionid()
        
        try:
            self.storage.check_submission_exists(id=submission_id)
        except InvalidSubmissionId:
            self.presenter.raise_exception_for_invalid_submission_id()
        ...
        try:
            ...
            self.presenter.raise_exception_for_submission_already_graded()
