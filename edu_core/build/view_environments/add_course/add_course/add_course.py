...
from edu_core.build.view_environments.add_course.add_course.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
options = {
    ...
    'REQUEST_SERIALIZER': courseSerializer,
...
def add_course(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "add_course", group_name, *args, **kwargs)
