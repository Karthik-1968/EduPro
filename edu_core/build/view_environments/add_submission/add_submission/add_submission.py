...
from edu_core.build.view_environments.add_submission.add_submission.adding_submission.adding_submissionSerializer import adding_submissionSerializer
from edu_core.build.view_environments.add_submission.add_submission.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
options = {
    ...
    'REQUEST_SERIALIZER': adding_submissionSerializer,
...
def add_submission(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "add_submission", group_name, *args, **kwargs)
