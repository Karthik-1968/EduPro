...
class ListAllCoursesRequestQueryParamType(object):
...
class ListAllCoursesRequestQueryParamSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return ListAllCoursesRequestQueryParamType(**validated_data)
