...
class AssignmentsOfCourseRequestQueryParamType(object):
...
class AssignmentsOfCourseRequestQueryParamSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return AssignmentsOfCourseRequestQueryParamType(**validated_data)
