...
from edu_core.build.view_environments.add_student_.add_student.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
def add_student(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "add_student", group_name, *args, **kwargs)
