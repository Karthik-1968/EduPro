...
from edu_core.build.view_environments.delete_assignment.delete_assignment.DeleteAssignmentRequestQueryParamSerializer import DeleteAssignmentRequestQueryParamSerializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': DeleteAssignmentRequestQueryParamSerializer,
...
def delete_assignment(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "delete_assignment", group_name, *args, **kwargs)
