...
class ListOfTeachersRequestQueryParamType(object):
...
class ListOfTeachersRequestQueryParamSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return ListOfTeachersRequestQueryParamType(**validated_data)
