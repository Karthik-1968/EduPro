...
from edu_core.build.view_environments.enroll_student_course.enroll_student_course.enrolling_student_course.enrolling_student_courseSerializer import enrolling_student_courseSerializer
from edu_core.build.view_environments.enroll_student_course.enroll_student_course.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
options = {
    ...
    'REQUEST_SERIALIZER': enrolling_student_courseSerializer,
...
app_name = "edu_core"
operation_id  = "enroll_student_course"
group_name = ""
...
def enroll_student_course(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "enroll_student_course", group_name, *args, **kwargs)
