...
from edu_core.build.view_environments.delete_teacher_.delete_teacher.DeleteTeacherRequestQueryParamSerializer import DeleteTeacherRequestQueryParamSerializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': DeleteTeacherRequestQueryParamSerializer,
...
def delete_teacher(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "delete_teacher", group_name, *args, **kwargs)
