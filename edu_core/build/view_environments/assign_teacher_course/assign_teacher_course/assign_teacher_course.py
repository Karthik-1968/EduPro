...
from edu_core.build.view_environments.assign_teacher_course.assign_teacher_course.assigning_teacher_course.assigning_teacher_courseSerializer import assigning_teacher_courseSerializer
from edu_core.build.view_environments.assign_teacher_course.assign_teacher_course.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
options = {
    ...
    'REQUEST_SERIALIZER': assigning_teacher_courseSerializer,
...
app_name = "edu_core"
operation_id  = "assign_teacher_course"
group_name = ""
...
def assign_teacher_course(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "assign_teacher_course", group_name, *args, **kwargs)
