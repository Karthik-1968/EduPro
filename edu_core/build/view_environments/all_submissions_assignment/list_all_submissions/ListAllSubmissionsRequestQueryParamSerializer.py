...
class ListAllSubmissionsRequestQueryParamType(object):
...
class ListAllSubmissionsRequestQueryParamSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return ListAllSubmissionsRequestQueryParamType(**validated_data)
