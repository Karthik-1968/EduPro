...
from edu_core.build.view_environments.grade_submission.grade_submission.GradeSubmissionRequestQueryParamSerializer import GradeSubmissionRequestQueryParamSerializer
from edu_core.build.view_environments.grade_submission.grade_submission.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
options = {
    ...
    'REQUEST_QUERY_PARAMS_SERIALIZER': GradeSubmissionRequestQueryParamSerializer,
...
def grade_submission(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "grade_submission", group_name, *args, **kwargs)
