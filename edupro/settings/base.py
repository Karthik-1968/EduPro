...
ALLOWED_HOSTS = [
    "edupro-prod.apigateway.in",
    "edupro-alpha.apigateway.in",
    "edupro-beta.apigateway.in",
    "edupro-gamma.apigateway.in",
    "edupro-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [edupro - "+os.environ.get("STAGE", "local")+
